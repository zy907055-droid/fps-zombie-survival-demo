...
public class WeaponManager : MonoBehaviour
{
    ...
    private void DropCurrentWeapon(GameObject pickedupWeapon)
    {
        if (activeWeaponSlot.transform.childCount > 0)
        {
            ...
            weaponToDrop.transform.SetParent(pickedupWeapon.transform.parent, false);
    ...
    internal void DecreaseTtotalAmmo(int bulletsToDecrease, Weapon.WeaponModel thisWeaponModel)
    {
